...
facedict={}
video_capture=None  #=cv2.VideoCapture(0)
...
def update_model(emotions):
    ...
    flag = checkForFolders(emotions)
    if flag!=1: #imgs in folder  not exists
        detect_face()       #firsst change
...
def checkForFolders(emotions):
    ...
    if flag==1:
        return 1 #images and dir already exists
    else:
        return 0
...
#It first calls testing.html in web fold,testing.html again calls file_Access.html it again code.js